  ...
  <body>
    <header class="wrapper">
      <nav class="inside_box">
        <div class="logo">
          <a href="#!"><img src="images/EscapeLogo.svg" alt="Escape head"></a>
        </div>
        <ul>
          <li class="nav_element"><a href="#!" class="no_lines">HOME</a></li>
    ...
    <main>
      <section>
        <div class="title_all"> 
          <h1 class="headline">The Road Ahead</h1> 
          <p class="annotation">The road ahead might be paved - it might not be</p>
        </div>
        <div class="lights_png">
          <img src="images/IMAGENothernLights.svg" alt="Nothern Lights">
        </div>
      </section>
      <section>
        <div class="text_frame">
          <p class="main_text">
            ...
            laughter more terrible than any sadness a laughter that was mirthless as the smile of
            the sphinx, a laughter cold as the frost and partaking of the grimness of infallibility. It was
            ...
            pot and frying-pan; but prominent, occupying most of the space, was the long and
            narrow oblong box.
            <br></br>
            ...
            and lips were so coated with the crystals from their frozen breath that their faces were
            not discernible. This gave them the seeming of ghostly masques, undertakers in a
        ...
        <div class="footer_list">
          <nav class="footer_nav">
            <div class="footer_logo">
              <a href="#!"><img src="images/EscapeFoot.svg" alt="Escape"></a>
            </div>
            <ul>
              <li class="down_item"><a href="#!" class="white_lines">HOME</a></li>
